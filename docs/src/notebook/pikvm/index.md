...
See [PiKVM-edid](https://docs.pikvm.org/edid/#default-edid) for more information about this.
...
[PiKVM-edid](https://docs.pikvm.org/edid/#default-edid). In my case using a `MSI PRO Z690-A`, then it looked like the
